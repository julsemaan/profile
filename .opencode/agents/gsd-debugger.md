...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/julien/src/profile/.opencode
                  → checks /home/julien/src/profile/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/julien/src/profile/.opencode/get-shit-done
                  → writes to /home/julien/src/profile/.opencode/get-shit-done/hooks/
...
```bash
node "/home/julien/src/profile/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/julien/src/profile/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
