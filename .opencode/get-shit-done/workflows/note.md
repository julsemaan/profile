...
- **Global scope**: `/home/julien/src/profile/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/julien/src/profile/.opencode/notes/`)
...
2. Glob `/home/julien/src/profile/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/julien/src/profile/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/julien/src/profile/.opencode/notes/` — works in any directory
