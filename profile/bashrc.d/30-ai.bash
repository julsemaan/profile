  ...
  case "${1:-}" in
    "")
      ...
      select opt in "openai (gpt-5.4-mini)" "deepseek (v4-flash)" "free (mimo-v2.5)"; do
        case $REPLY in
          1) _GCOTO_MODEL="openai-codex/gpt-5.4-mini"; break ;;
          2) _GCOTO_MODEL="deepseek/deepseek-v4-flash"; break ;;
          3) _GCOTO_MODEL="opencode/mimo-v2.5-free"; break ;;
    ...
    *)         echo "gcoto-model: unknown option '$1' — use openai, deepseek, free, current, or unset" >&2; return 1 ;;
  esac
}
