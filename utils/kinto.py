...
define_keymap(lambda wm_class: wm_class.casefold() not in remotes,{
    ...
    K("Alt-down") : K("PAGE_DOWN"), #CUSTOM
    K("Alt-up") : K("PAGE_UP"),     #CUSTOM
...
define_keymap(lambda wm_class: wm_class.casefold() not in remotes,{
    ...
    # Firefox fix:
    # set "ui.key.menuAccessKeyFocuses" to false in about:config.
}, "Wordwise")
...
define_keymap(re.compile("^Io.elementary.terminal$|^kitty$|^ghostty$|^com.mitchellh.ghostty$", re.IGNORECASE),{
    # Ctrl Tab - In App Tab Switching
    K("LC-Tab") : K("LC-Shift-Right"),
    K("LC-Shift-Tab") : K("LC-Shift-Left"),
    K("LC-Grave") : K("LC-Shift-Left"),

}, "Elementary Terminal, Kitty, and Ghostty tab switching")
